    ...
    <header class="header">
        ...
        <div class="compwindow container col-md-12 row">
            ...
            <div class="compbord row container col-md-2">
                <img src="evo.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">Samsung 860 EVO</h3>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseTwo" class="collapse col-md-12" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="card-body itemdesc">
                          <dl>
                              <dt>
                                Interface: SATA 6Gb/s, 3Gb/s, and 1.5Gb/s
                              </dt>
                              <dt>
                                Capacities: 250GB, 500GB, 1TB, 2TB, and 4TB
                              </dt>
                              <dt>
                                Write Speed: 520MB/s
                              </dt>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseThree" class="collapse col-md-12" aria-labelledby="headingThree" data-parent="#accordionExample">
                        ...
                        <?php
                          ...
                          {
                              $Subject = stripslashes("Samsung 860 EVO");
                              $Name = stripslashes("SSD");
                              $Message = stripslashes("Samsung");
            ...
            <div class="compbord row container col-md-2">
                <img src="kingston.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">Kingston a400</h3>
                      ...
                      <div id="collapseFour" class="collapse col-md-12" aria-labelledby="headingFour" data-parent="#accordionExample">
                        <div class="card-body itemdesc">
                            <dl>
                                ...
                                <dt>
                                  Capacities: 120GB, 240GB, and 960GB
                                </dt>
                                <dt>
                                  Write Speed: 500MB/s
                                </dt>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseFive" class="collapse col-md-12" aria-labelledby="headingFive" data-parent="#accordionExample">
                        <div class="card-body text-center">
                            ...
                            {
                                $Subject = stripslashes("Kingston a400");
                                $Name = stripslashes("SSD");
                                $Message = stripslashes("Kingston");
            ...
            <div class="compbord row container col-md-2">
                <img src="wd.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">WD Green</h3>
                ...
                <div class="accordion" id="accordionExample">
                      ...
                      <div id="collapseSix" class="collapse col-md-12" aria-labelledby="headingSix" data-parent="#accordionExample">
                        <div class="card-body itemdesc">
                            <dl>
                                ...
                                <dt>
                                  Capacities: 120GB, 240GB, 480GB, 1TB, and 2TB
                                </dt>
                                <dt>
                                  Write Speed: 545MB/s
                                </dt>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseSeven" class="collapse col-md-12" aria-labelledby="headingSeven" data-parent="#accordionSeven">
                        ...
                        {
                            $Subject = stripslashes("WD Green");
                            $Name = stripslashes("SSD");
                            $Message = stripslashes("WD");
            ...
            <div class="compbord row container col-md-2">
                <img src="sandisk.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">SanDisk SSD Plus</h3>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                      ...
                      <div id="collapseNine" class="collapse col-md-12" aria-labelledby="headingNine" data-parent="#accordionnine">
                        ...
                        {
                            $Subject = stripslashes("SanDisk SSD Plus");
                            $Name = stripslashes("SSD");
                            $Message = stripslashes("SanDisk");

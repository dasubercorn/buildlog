        ...
        <h1 style = "color: white">Our Recommendations:</h1>
         ...
         <div class="compwindow container col-md-12 row">
            ...
            <div class="compbord row container col-md-2">
                <img src="fury.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">Kingston Fury Beast</h3>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                      ...
                      <div id="collapseThree" class="collapse col-md-12" aria-labelledby="headingThree" data-parent="#accordionExample">
                        ...
                        {
                            $Subject = stripslashes("Kingston Fury Beast");
                            $Name = stripslashes("RAM");
            ...
            <div class="compbord row container col-md-2">
                <img src="dominator.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">Corsair Dominator</h3>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                      ...
                      <div id="collapseFive" class="collapse col-md-12" aria-labelledby="headingFive" data-parent="#accordionExample">
                        ...
                        {
                            $Subject = stripslashes("Corsair Dominator");
                            $Name = stripslashes("RAM");
                            $Message = stripslashes("Corsair");
            ...
            <div class="compbord row container col-md-2">
                <img src="trident.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">Gskill Trident z5</h3>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                      ...
                      <div id="collapseSeven" class="collapse col-md-12" aria-labelledby="headingSeven" data-parent="#accordionSeven">
                        ...
                        {
                            $Subject = stripslashes("Gskill Trident z5");
                            $Name = stripslashes("RAM");
                            $Message = stripslashes("Gskill");
            ...
            <div class="compbord row container col-md-2">
                <img src="xpg.jpg" class="col-md-12"alt="" height="250">
                <h3 class="itemdesc">XPG Lancer RGB</h3>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                      ...
                      <div id="collapseNine" class="collapse col-md-12" aria-labelledby="headingNine" data-parent="#accordionnine">
                        ...
                        {
                            $Subject = stripslashes("XPG Lancer RGB");
                            $Name = stripslashes("RAM");
                            $Message = stripslashes("XPG");

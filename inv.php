...
<head>
    ...
    <title>BUILD LOG | INVENTORY</title>
...
<body class>
    ...
    if(isset($_GET['action'])){
        if((file_exists("MessageBoard/inv.txt")) &&
        (filesize("MessageBoard/inv.txt") != 0))
    {
        $MessageArray = file ("MessageBoard/inv.txt");
        ...
        if(count($MessageArray) > 0)
            {
                ...
                $MessageStore = fopen("MessageBoard/inv.txt", "wb");
    ...
    else
    {
        ...
        for ($i = 0; $i < $count; ++$i)
        {
            ...
            echo "<td width = \"10%\"
                    style = \"text-align:center;\">" . 
                    "<a style = \"color: white;\" href = 'inv.php?" . 
                    "action=Delete%20Message&" . 
                    "message=$i'>" .
                    "Remove From Inventory </a></td> \n";
    ...
    <p>
        ...
        <form action="inv.php?action=Remove%20Duplicates" method = "POST">
           <input class="buybtn btn btn-success" type="submit" value = "Remove Duplicate Components">
        </form>
        <p> </p>

        <form action="inv.php?action=Delete%20First" method = "POST">
           <input class="buybtn btn btn-success" type="submit" value = "Delete First Entry">
        </form>

        <p> </p>

        <form action="inv.php?action=Delete%20Last" method = "POST">
